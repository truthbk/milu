...
FIND_PATH(CUNIT_SHARE_DIR CUnit-List.dtd
	/usr/local/share/CUnit/Unit
	/usr/share/CUnit
	/opt/local/share/CUnit
	)

# On unix system,system debug and release have the same name
...
IF(CUNIT_INCLUDE_DIR)
	IF(CUNIT_LIBRARY)
		SET(CUNIT_FOUND "YES")
		if (WIN32)
			SET(CUNIT_LIBRARIES ${CUNIT_LIBRARY})    SET(CUNIT_DEBUG_LIBRARIES ${CUNIT_DEBUG_LIBRARY})
		else (WIN32)
	...
	IF(CUNIT_INCLUDE_DIR)
		if (WIN32IN32)
			...
			SET(CUNIT_INCLUDE_DIRSE_DIRS ${CUNIT_INCLUDE_DIR} ${CURSES_INCLUDE_DIR})
		endif (WIN32)
